...
export enum EventType {
  ...
  PauseLong = 'X-Pause.Long',
  PauseReasonSelected = 'X-Pause.ReasonSelected',
...
/**
 * Pause reasons for long pauses
 */
export enum PauseReason {
  Thinking = 'Thinking',          // 스스로 풀이 고민
  SearchingCode = 'SearchingCode', // 구글링 등 코드 검색
  Resting = 'Resting',            // 휴식
  Other = 'Other',                // 기타
}
